...
}, comments = "wadl2java, http://wadl.java.net", date = "2020-01-18T16:51:09.157+01:00")
public class Localhost_BiblioSystemRest {
    ...
    public static class Biblio {
        ...
        public Localhost_BiblioSystemRest.Biblio.BookshelvesName bookshelvesName(String name) {
            return new Localhost_BiblioSystemRest.Biblio.BookshelvesName(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), name);
        }

        public Localhost_BiblioSystemRest.Biblio.BookshelvesNameId bookshelvesNameId(String name, String id) {
            return new Localhost_BiblioSystemRest.Biblio.BookshelvesNameId(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), name, id);
        }

        public Localhost_BiblioSystemRest.Biblio.BookshelvesNameReads bookshelvesNameReads(String name) {
            return new Localhost_BiblioSystemRest.Biblio.BookshelvesNameReads(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), name);
        }
        ...
        public static class BookshelvesName {

            private Client _client;
            private UriBuilder _uriBuilder;
            private Map<String, Object> _templateAndMatrixParameterValues;

            private BookshelvesName(Client client, UriBuilder uriBuilder, Map<String, Object> map) {
                _client = client;
                _uriBuilder = uriBuilder.clone();
                _templateAndMatrixParameterValues = map;
            }
             ...
             * 
             */
            public BookshelvesName(Client client, URI baseUri, String name) {
                _client = client;
                _uriBuilder = UriBuilder.fromUri(baseUri);
                _uriBuilder = _uriBuilder.path("/bookshelves/{name}");
                _templateAndMatrixParameterValues = new HashMap<String, Object>();
             ...
             * 
             */
            public BookshelvesName(Client client, URI uri) {
                _client = client;
                StringBuilder template = new StringBuilder(BASE_URI.toString());
                if (template.charAt((template.length()- 1))!= '/') {
                    template.append("/biblio/bookshelves/{name}");
                } else {
                    template.append("biblio/bookshelves/{name}");
                }
             ...
             * 
             */
            public Localhost_BiblioSystemRest.Biblio.BookshelvesName setName(String name) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("name", name);
                return new Localhost_BiblioSystemRest.Biblio.BookshelvesName(_client, copyUriBuilder, copyMap);
            }
        ...
        public static class BookshelvesNameId {

            private Client _client;
            private UriBuilder _uriBuilder;
            private Map<String, Object> _templateAndMatrixParameterValues;

            private BookshelvesNameId(Client client, UriBuilder uriBuilder, Map<String, Object> map) {
                _client = client;
                _uriBuilder = uriBuilder.clone();
                _templateAndMatrixParameterValues = map;
            }
             ...
             * 
             */
            public BookshelvesNameId(Client client, URI baseUri, String name, String id) {
                _client = client;
                _uriBuilder = UriBuilder.fromUri(baseUri);
                _uriBuilder = _uriBuilder.path("/bookshelves/{name}/{id}");
                _templateAndMatrixParameterValues = new HashMap<String, Object>();
                _templateAndMatrixParameterValues.put("name", name);
             ...
             * 
             */
            public BookshelvesNameId(Client client, URI uri) {
                _client = client;
                StringBuilder template = new StringBuilder(BASE_URI.toString());
                if (template.charAt((template.length()- 1))!= '/') {
                    template.append("/biblio/bookshelves/{name}/{id}");
                } else {
                    template.append("biblio/bookshelves/{name}/{id}");
                }
                _uriBuilder = UriBuilder.fromPath(template.toString());
             ...
             * 
             */
            public Localhost_BiblioSystemRest.Biblio.BookshelvesNameId setName(String name) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("name", name);
                return new Localhost_BiblioSystemRest.Biblio.BookshelvesNameId(_client, copyUriBuilder, copyMap);
            }
             ...
             * 
             */
            public Localhost_BiblioSystemRest.Biblio.BookshelvesNameId setId(String id) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("id", id);
        ...
        public static class BookshelvesNameReads {

            private Client _client;
            private UriBuilder _uriBuilder;
            private Map<String, Object> _templateAndMatrixParameterValues;

            private BookshelvesNameReads(Client client, UriBuilder uriBuilder, Map<String, Object> map) {
                _client = client;
                _uriBuilder = uriBuilder.clone();
                _templateAndMatrixParameterValues = map;
            }
             ...
             * 
             */
            public BookshelvesNameReads(Client client, URI baseUri, String name) {
                _client = client;
                _uriBuilder = UriBuilder.fromUri(baseUri);
                _uriBuilder = _uriBuilder.path("/bookshelves/{name}/reads");
                _templateAndMatrixParameterValues = new HashMap<String, Object>();
                _templateAndMatrixParameterValues.put("name", name);
            }
             ...
             * 
             */
            public BookshelvesNameReads(Client client, URI uri) {
                _client = client;
                StringBuilder template = new StringBuilder(BASE_URI.toString());
                if (template.charAt((template.length()- 1))!= '/') {
                    template.append("/biblio/bookshelves/{name}/reads");
                } else {
                    template.append("biblio/bookshelves/{name}/reads");
                }
                _uriBuilder = UriBuilder.fromPath(template.toString());
             ...
             * 
             */
            public Localhost_BiblioSystemRest.Biblio.BookshelvesNameReads setName(String name) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("name", name);
                return new Localhost_BiblioSystemRest.Biblio.BookshelvesNameReads(_client, copyUriBuilder, copyMap);
            }
